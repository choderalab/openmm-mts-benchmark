...
def benchmark(system, positions, integrator, platform_name='CUDA', precision='mixed', nsteps=500):
    ...
    # TODO: Set PME properties to deterministic?
...
# Load in Villin Test System
class VillinExplicitSystem(TestSystem):
    """Villin headpiece
    ...
    def __init__(self, nonbondedMethod=app.PME, nonbondedCutoff=DEFAULT_CUTOFF_DISTANCE, switch_width=DEFAULT_SWITCH_WIDTH, ewaldErrorTolerance=DEFAULT_EWALD_ERROR_TOLERANCE, hydrogenMass=None, use_dispersion_correction=True, **kwargs):
        ...
        prefix = '/home/sukrit/lilac/data/villin-mts-integrator/sim-benchmark/LangevinMiddleIntegrator_4fs'
        import os

        system = deserialize(os.path.join(prefix, 'system.xml.bz2'))
        state = deserialize(os.path.join(prefix, 'state.xml.bz2'))
        pdbfile = app.PDBFile(os.path.join(prefix, 'receptor_equilibrated.pdb'))
...
# Load in menin test system
class MeninExplicitSystem(TestSystem):
    """Menin
    ...
    def __init__(self, nonbondedMethod=app.PME, nonbondedCutoff=DEFAULT_CUTOFF_DISTANCE, switch_width=DEFAULT_SWITCH_WIDTH, ewaldErrorTolerance=DEFAULT_EWALD_ERROR_TOLERANCE, hydrogenMass=None, use_dispersion_correction=True, **kwargs):
        ...
        prefix = '/home/sukrit/lilac/warm/menin/sim-setup/apo/wt/struc2'
        import os
...
#    'WaterBox PME 8A cutoff' : testsystems.WaterBox(constrained=True, nonbondedMethhod=app.PME, box_edge=25*unit.angstroms, dispersion_correction=True, cutoff=8.0*unit.angstroms, switch_width=None, ewaldErrorTolerance=5e-4),
#    'WaterBox PME 9A cutoff' : testsystems.WaterBox(constrained=True, nonbondedMethhod=app.PME, box_edge=25*unit.angstroms, dispersion_correction=True, cutoff=9.0*unit.angstroms, switch_width=None, ewaldErrorTolerance=5e-4),
#    'WaterBox PME 10A cutoff' : testsystems.WaterBox(constrained=True, nonbondedMethhod=app.PME, box_edge=25*unit.angstroms, dispersion_correction=True, cutoff=10.0*unit.angstroms, switch_width=None, ewaldErrorTolerance=5e-4),
#    'WaterBox PME 11A cutoff' : testsystems.WaterBox(constrained=True, nonbondedMethhod=app.PME, box_edge=25*unit.angstroms, dispersion_correction=True, cutoff=11.0*unit.angstroms, switch_width=None, ewaldErrorTolerance=5e-4),
#    'WaterBox RF 12A cutoff' : testsystems.WaterBox(constrained=True, nonbondedMethhod=app.CutoffPeriodic, box_edge=25*unit.angstroms, dispersion_correction=True, cutoff=12.0*unit.angstroms, switch_width=None, ewaldErrorTolerance=5e-4),
#    'Big WaterBox PME 9A cutoff' : testsystems.WaterBox(constrained=True, nonbondedMethhod=app.PME, box_edge=50*unit.angstroms, dispersion_correction=True, cutoff=9.0*unit.angstroms, switch_width=None, ewaldErrorTolerance=5e-4),
...
#    'SrcExplicit RF 12A' : testsystems.SrcExplicitReactionField(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=EWALD_ERROR_TOLERANCE, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
...
#    'cellulose 12A cutoff 1e-5' : FAHTestSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-5, switch_width=None, nonbondedCutoff=12.0*unit.angstroms, run='RUN17'),
    'Villin PME  9A cutoff 5e-4 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-4, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
    'Villin PME  9A cutoff 1e-4 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-4, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
    'Villin PME  9A cutoff 5e-5 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-5, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
    'Villin PME  9A cutoff 1e-5 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-5, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
    'Villin PME 12A cutoff 5e-4 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-4, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
    'Villin PME 12A cutoff 1e-4 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-4, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
    'Villin PME 12A cutoff 5e-5 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-5, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
    'Villin PME 12A cutoff 1e-5 tol' : VillinExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-5, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
#    'Menin PME  9A cutoff 5e-4 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-4, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
#    'Menin PME  9A cutoff 1e-4 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-4, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
#    'Menin PME  9A cutoff 5e-5 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-5, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
#    'Menin PME  9A cutoff 1e-5 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-5, switch_width=None, nonbondedCutoff=9.0*unit.angstroms),
#    'Menin PME 12A cutoff 5e-4 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-4, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
#    'Menin PME 12A cutoff 1e-4 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-4, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
#    'Menin PME 12A cutoff 5e-5 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=5e-5, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
#    'Menin PME 12A cutoff 1e-5 tol' : MeninExplicitSystem(hydrogenMass=HYDROGEN_MASS, ewaldErrorTolerance=1e-5, switch_width=None, nonbondedCutoff=12.0*unit.angstroms),
    }
...
# Write out benchmarks to CSV file for later analysis
